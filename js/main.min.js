...
/* harmony import */ var _modules_burger_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/burger/index */ "./js/modules/burger/index.js");
/* harmony import */ var _modules_map_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/map/index */ "./js/modules/map/index.js");
...
/* harmony import */ var _init_locomotive_scroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./init-locomotive-scroll */ "./js/modules/burger/init-locomotive-scroll.js");


window.addEventListener('DOMContentLoaded', function () {
  Object(_init_locomotive_scroll__WEBPACK_IMPORTED_MODULE_1__["initLocomotiveScroll"])();
  window.addEventListener('load', function () {
...
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    Object(_init_map__WEBPACK_IMPORTED_MODULE_0__["activateMapOnScroll"])();
  });
});
...
/*!************************************!*\
  !*** ./js/modules/map/init-map.js ***!
  \************************************/
/*! exports provided: activateMapOnScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "activateMapOnScroll", function() { return activateMapOnScroll; });
// const initMap = () => {
...
var myOwnScriptElement = document.createElement('script');
...
function initYandexMap() {
  ...
  var Placemark = new ymaps.Placemark([59.93863106417265, 30.323036499999905], {}, {
    iconLayout: 'default#image',
    iconImageHref: 'img/sprite/icon_pin.svg',
    iconImageSize: [18, 22],
    iconImageOffset: [-9, -22],
...
var insertApiToHead = function insertApiToHead() {
...
function activateMapOnScroll() {
  if (mapElement.getBoundingClientRect().top - window.innerHeight < 2000 && !switcher) {
    switcher = true;
    insertApiToHead();
    myOwnScriptElement.addEventListener('load', function () {
